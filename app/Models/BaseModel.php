...
abstract class BaseModel
{
    ...
    protected function paginate($sql, $args = [], $fetchMode = PDO::FETCH_ASSOC){
        //! Step 1) Get/Compute the number of records that will be generated by the provided query(call teh count method)
         $number_of_records = $this->count($sql,$args);
        ...
        //! Step 3) Get the offset from the PaginationHelper's instance
        $offSet = $paginator->getOffset();
        //! Step 4) Add the following to your query
        //! $sql .= 'Limit (number of row, number of data)
        $sql .= " LIMIT $offSet, $this->records_per_page";
        //! Step 5) Get the pagination info from the paginator's instance 
        $result = $paginator->getPaginationInfo();
        //! Step 5.a) Execute the query result to the pagination info.
        $result['data'] = $this->fetchAll($sql, $args);
